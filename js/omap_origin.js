...
function strongholdInfo(stronghold) {
    ...
    if (stronghold.business_week != undefined) {
        ...
        infoHTML += "<table class='tg'><tr><th class='tg-lboi'></th><th class='tg-lboi'>一</th><th class='tg-lboi'>二</th><th class='tg-lboi'>三</th><th class='tg-lboi'>四</th><th class='tg-lboi'>五</th><th class='tg-cly1'>六</th><th class='tg-0lax'>日</th></tr><tr><td class='tg-lboi'>上</td><td class='tg-lboi'>" + business_week[0] + "</td><td class='tg-lboi'>" + business_week[1] + "</td><td class='tg-lboi'>" + business_week[2] + "</td><td class='tg-lboi'>" + business_week[3] + "</td><td class='tg-lboi'>" + business_week[4] + "</td><td class='tg-gg7l'>" + business_week[5] + "</td><td class='tg-kftd'>" + business_week[6] + "</td></tr><tr><td class='tg-lboi'>下</td><td class='tg-lboi'>" + business_week[7] + "</td><td class='tg-lboi'>" + business_week[8] + "</td><td class='tg-lboi'>" + business_week[9] + "</td><td class='tg-lboi'>" + business_week[10] + "</td><td class='tg-lboi'>" + business_week[11] + "</td><td class='tg-gg7l'>" + business_week[12] + "</td><td class='tg-kftd'>" + business_week[13] + "</td></tr><tr><td class='tg-0pky'>晚</td><td class='tg-0pky'>" + business_week[14] + "</td><td class='tg-0pky'>" + business_week[15] + "</td><td class='tg-0pky'>" + business_week[16] + "</td><td class='tg-0pky'>" + business_week[17] + "</td><td class='tg-0pky'>" + business_week[18] + "</td><td class='tg-kftd'>" + business_week[19] + "</td><td class='tg-kftd'>" + business_week[20] + "</td></tr></table><br />";
    }
